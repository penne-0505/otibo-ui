...
import { CardRoot, CardHeader, CardTitle, CardDescription, CardBody, CardFooter } from "./card"
...
export const BrandStatement: Story = () => (
  <div style={{ maxWidth: 520 }}>
    <CardRoot>
      <CardHeader>
        <CardTitle>ひと手間に、ぴったりの道具を。</CardTitle>
        <CardDescription>
...
export const DashboardMetric: Story = () => (
  ...
  >
    {[
      ...
      <CardRoot key={metric.label} surface="paper" padding="md">
        <CardHeader>
...
export const ProseCallout: Story = () => (
  ...
  >
    ...
    <CardRoot surface="muted" padding="md">
      <CardBody>
        <p style={{ margin: 0 }}>
